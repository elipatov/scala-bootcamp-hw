...
object HomeworkSpec {
  @ConfiguredJsonCodec final case class TeamTotals(
      assists: String,
      @JsonKey("full_timeout_remaining")
  ...
  implicit val decodeDate: Decoder[LocalDate] = Decoder.decodeString
    .emap(s =>
...
//  implicit val songDecoder: Decoder[Scoreboard] =
//    Decoder.forProduct2("title", "length")(Scoreboard.apply)
